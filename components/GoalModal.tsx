    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 animate-in fade-in duration-200">
      <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-2xl scale-100 transition-transform">
        <div className="flex justify-between items-center mb-4 border-b pb-2">
            <h3 className="text-lg font-bold text-slate-800">Configurar Metas</h3>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Meta Trabalhados (Ciclo)</label>
            <input 
                type="number" 
          ...
          <div className="flex gap-3">
            <div className="w-1/2">
                <label className="block text-sm font-semibold text-gray-700 mb-1">Mín Diária</label>
                <input 
                    type="number" 
            ...
            <div className="w-1/2">
                <label className="block text-sm font-semibold text-gray-700 mb-1">Máx Diária</label>
                <input 
                    type="number" 
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-1">Eficiência Mínima (%)</label>
            <input 
                type="number" 
        ...
        <div className="mt-8 flex justify-end gap-2">
          ...
          <button onClick={onClose} className="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 shadow-md hover:shadow-lg transition-all">Salvar Alterações</button>
        </div>
      </div>
    </div>
  );
